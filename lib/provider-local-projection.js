import { projectBoveressesCareDetail } from "./provider-care-projection.js";
...
export function projectLocalReviewedProvider(staticProvider, snapshot) {
  ...
  const careDetail = staticProvider.slug === "ems-boveresses"
    ? projectBoveressesCareDetail(snapshot) : null;
  return {
    ...staticProvider,
    name: row.name,
